...
const CACHE_NAME = 'gakushu-quest-v20';
...
const ASSETS = [
  ...
  './data/sep16_math.js',
  './data/sep16_english.js',
  './data/njz_nijikansuu_zero.js',
  './data/ecz_denki_kairo_zero.js',
